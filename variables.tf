variable "subscription_template_deployments" {
  description = <<EOT
Map of subscription_template_deployments, attributes below
Required:
    - location
    - name
Optional:
...
EOT
  ...
  # --- Unconfirmed validation candidates, derived from azurerm_subscription_template_deployment's provider source ---
